	...
	*/
    ...
    switch($ni->name)
       ...
       case "Opel":
           ...
           break;
       case "Service":
           $classes[] = "rest service";
           $ni->wasThere = FALSE;
           break;
       case "Kontakt":
           $classes[] = "rest kontakt";
           $ni->wasThere = FALSE;
           break;
       case "Kunst":
           $classes[] = "rest kunst";
...
foreach ($navItems as $ni) {
	...
	if ($ni->isEnabled) {
		echo '<a href="' . $ni->url . '" target="' . $ni->target . '" class="' . $ni->classes . '" title="' . $ni->name . '">';
        if($ni->wasThere) {
            echo '</a>';
        }
